    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900 section-padding">
      <Card className="w-full max-w-md animate-in fade-in zoom-in duration-300">
        <CardHeader className="text-center">
          <CardTitle className="text-3xl font-bold tracking-tight text-primary">Gastos Tracker</CardTitle>
        ...
        <CardContent>
          <form className="space-y-4">
            ...
            <Button formAction={loginWithGoogle} variant="secondary" className="w-full" type="submit">
                Google
            </Button>
          </form>
        </CardContent>
