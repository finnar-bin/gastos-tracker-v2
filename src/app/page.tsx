...
export default async function Dashboard() {
  ...
  // Fetch transactions here (future)
  ...
  return (
    <div className="container max-w-md mx-auto p-4 space-y-6 pb-20">
      ...
      <div className="grid grid-cols-2 gap-4">
          <Link href="/add?type=income" className="w-full">
            <Button variant="outline" className="w-full h-24 flex flex-col gap-2 hover:bg-green-50 hover:text-green-600 dark:hover:bg-green-950 dark:hover:text-green-400 border-dashed">
                 <Plus className="h-6 w-6 text-green-500" />
                 <span className="font-medium">Income</span>
            </Button>
          </Link>
          <Link href="/add?type=expense" className="w-full">
            <Button variant="outline" className="w-full h-24 flex flex-col gap-2 hover:bg-red-50 hover:text-red-600 dark:hover:bg-red-950 dark:hover:text-red-400 border-dashed">
